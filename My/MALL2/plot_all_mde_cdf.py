...
# 5. 定義實驗場景
SCENARIOS = {
    "experiments": ("211120_results.csv", "221221_results.csv")
}
...
MAP_FILE_PATH = r'D:/paper_thesis/My/data/MTLocData/Mall/processed_data/Mall_1_training_vs_Mall_7_training/experiment_class_map.csv'
