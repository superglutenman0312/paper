...
# $modes = @("Labeled")
# 4. 資料路徑設定 (避免底下指令太長)
$sourceData = "D:/paper_thesis/My/data/MTLocData/Mall/processed_data/Mall_1_training_vs_Mall_7_training/source_train.csv"
$targetData = "D:/paper_thesis/My/data/MTLocData/Mall/processed_data/Mall_1_training_vs_Mall_7_training/target_train.csv"
$workDir = "experiments"
