...
foreach ($Mode in @("labeled", "unlabeled")) {
    ...
    foreach ($Beta in $BetaValues) {
        ...
        foreach ($Seed in $Seeds) {
            ...
            python .\SWD\SWD.py --training_source_domain_data D:/paper_thesis/My/data/MTLocData/Mall/processed_data/Mall_1_training_vs_Mall_7_training/source_train.csv `
