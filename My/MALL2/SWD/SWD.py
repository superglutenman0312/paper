'''
python SWD.py --training_source_domain_data D:/paper_thesis/My/data/MTLocData/Mall/processed_data/Mall_1_training_vs_Mall_7_training/source_train.csv `
             --training_target_domain_data D:/paper_thesis/My/data/MTLocData/Mall/processed_data/Mall_1_training_vs_Mall_7_training/target_train.csv `
             --work_dir experiments `
             --loss_weights 1 10 --epoch 150 --random_seed 42 --unlabeled
...
if __name__ == "__main__":
    ...
    for data_drop_out in data_drop_out_list:
        ...
        if args.training_source_domain_data and args.training_target_domain_data:
            ...
            testing_file_paths = [
                        r'D:/paper_thesis/My/data/MTLocData/Mall/processed_data/Mall_1_training_vs_Mall_7_training/source_test.csv',
                        r'D:/paper_thesis/My/data/MTLocData/Mall/processed_data/Mall_1_training_vs_Mall_7_training/target_test.csv'
                    ]
