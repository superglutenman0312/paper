r'''
python DNN.py --training_source_domain_data D:/paper_thesis/My/data/MTLocData/Mall/2021-11-20/wireless_training.csv `
...
python DNN.py --test --work_dir experiments `
             --epoch 1 --random_seed 42 --unlabeled
'''
