...
# foreach ($Mode in @("unlabeled")) {
    ...
    foreach ($Beta in $BetaValues) {
        ...
        foreach ($Seed in $Seeds) {
            ...
            python .\SWD\SWD.py --training_source_domain_data D:\paper_thesis\My\data\MCSL\processed_data\20220318_20231116\source_train.csv `
                                  ...
                                  --loss_weights $Alpha $Beta --epoch $EpochNum --random_seed $Seed --case 1 $Flag
            ...
            python .\SWD\SWD.py --training_source_domain_data D:/paper_thesis/Histloc_real/Experiment/data/231116/GalaxyA51/wireless_training.csv `
                                  ...
                                  --loss_weights $Alpha $Beta --epoch $EpochNum --random_seed $Seed --case 2 $Flag
