r'''
# time reversal 1
python DNN_reverse.py --training_source_domain_data D:\paper_thesis\Histloc_real\Experiment\data\UM_DSI_DB_v1.0.0_lite\data\tony_data_reverse\2020-02-19\wireless_training.csv `
                     ...
                     --epoch 1 --random_seed 42 --unlabeled
python DNN_reverse.py --test --work_dir time_reversal_1 `
                     --epoch 1 --random_seed 42 --unlabeled
...
python DNN_reverse.py --training_source_domain_data D:\paper_thesis\Histloc_real\Experiment\data\UM_DSI_DB_v1.0.0_lite\data\tony_data_reverse\2020-02-19\wireless_training.csv `
                     ...
                     --epoch 1 --random_seed 42 --unlabeled
python DNN_reverse.py --test --work_dir time_reversal_2 `
                     --epoch 1 --random_seed 42 --unlabeled
'''
