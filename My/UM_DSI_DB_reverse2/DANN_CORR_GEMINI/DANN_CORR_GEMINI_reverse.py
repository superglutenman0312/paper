r'''
# time reversal 1
python DANN_CORR_GEMINI_reverse.py --training_source_domain_data D:\paper_thesis\Histloc_real\Experiment\data\UM_DSI_DB_v1.0.0_lite\data\tony_data_reverse\2020-02-19\wireless_training.csv `
...
python DANN_CORR_GEMINI_reverse.py --test --work_dir time_reversal_1
...
python DANN_CORR_GEMINI_reverse.py --training_source_domain_data D:\paper_thesis\Histloc_real\Experiment\data\UM_DSI_DB_v1.0.0_lite\data\tony_data_reverse\2020-02-19\wireless_training.csv `
                               ...
                               --random_seed 42 --unlabeled
python DANN_CORR_GEMINI_reverse.py --test --work_dir time_reversal_2
'''
import torch
