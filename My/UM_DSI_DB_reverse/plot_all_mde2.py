...
SEEDS = [42, 70, 100]
EPOCH_SWD = 300
EPOCH_WD = 300   # [新增] 預設與 SWD 相同，若實際為 1 請自行修改

# 2. 定義要比較的 WD 參數變體 (新增)
#    比照 SWD 邏輯設定。若您的實驗參數不同 (例如是 1_5)，請在此修改
WD_VARIANTS = [
    (1.0, 1.0, "WD_1_1"),
    (1.0, 10.0, "WD_1_10"),
    (1.0, 100.0, "WD_1_100")
...
# 6. 輸出目錄
OUTPUT_DIR = "Comparison_Result_Reversal_WD"
...
# Time Reversal / Time Variation 專用座標
...
def plot_combined_comparison(df, title_seed_part, exp_name, output_filename):
    ...
    fig, axes = plt.subplots(1, 2, figsize=(20, 7)) # 加寬畫布
