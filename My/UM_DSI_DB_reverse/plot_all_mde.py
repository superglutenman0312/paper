...
# 1. 隨機種子與 Epoch 設定
#    注意: Time Reversal 實驗中，SWD 的 Epoch 設定為 300
SEEDS = [42, 70, 100]
EPOCH_SWD = 300
...
# 4. 定義實驗場景 (對應資料夾名稱與檔案標籤)
#    格式: 場景名稱: (Source檔名, Target檔名)
#    Time Reversal 1: Source(200219) -> Target(190611)
#    Time Reversal 2: Source(200219) -> Target(191009)
SCENARIOS = {
    "time_reversal_1": ("200219_results.csv", "190611_results.csv"),
    "time_reversal_2": ("200219_results.csv", "191009_results.csv")
}

# 5. 輸出目錄
OUTPUT_DIR = "Comparison_Result_Reversal"
...
# 專用於 Time Reversal / Time Variation 的標籤座標對照表
...
def get_other_mde(exp_type, seed, mode, method_name, src_file, tgt_file):
    """
    取得其他方法的 MDE
    路徑: {method_name}/{exp_type}/random_seed_{seed}/*_{mode}/predictions/
    """
    ...
    # 搜尋結尾是 _mode 的資料夾 (e.g., _labeled 或 _unlabeled)
    # 注意: 這裡假設資料夾名稱格式例如 "20241122_labeled" 或單純 "_labeled" 結尾
