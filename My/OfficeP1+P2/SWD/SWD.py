'''
python SWD.py --training_source_domain_data D:/paper_thesis/My/data/MTLocData/OfficeP1+P2/processed_data/OfficeP1+P2_1_training_vs_OfficeP1+P2_38_training/source_train.csv `
             --training_target_domain_data D:/paper_thesis/My/data/MTLocData/OfficeP1+P2/processed_data/OfficeP1+P2_1_training_vs_OfficeP1+P2_38_training/target_train.csv `
             --work_dir experiments `
             --loss_weights 1 1 --epoch 100 --random_seed 42 --unlabeled
...
if __name__ == "__main__":
    ...
    for data_drop_out in data_drop_out_list:
        ...
        if args.training_source_domain_data and args.training_target_domain_data:
            ...
            testing_file_paths = [
                        r'D:/paper_thesis/My/data/MTLocData/OfficeP1+P2/processed_data/OfficeP1+P2_1_training_vs_OfficeP1+P2_38_training/source_test.csv',
                        r'D:/paper_thesis/My/data/MTLocData/OfficeP1+P2/processed_data/OfficeP1+P2_1_training_vs_OfficeP1+P2_38_training/target_test.csv'
                    ]
            output_paths = ['predictions/200925_results.csv', 'predictions/211204_results.csv']
