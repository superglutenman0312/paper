...
foreach ($Mode in @("labeled", "unlabeled")) {
    ...
    foreach ($Beta in $BetaValues) {
        ...
        foreach ($Seed in $Seeds) {
            ...
            python .\SWD\SWD.py --training_source_domain_data D:/paper_thesis/My/data/MTLocData/OfficeP1+P2/processed_data/OfficeP1+P2_1_training_vs_OfficeP1+P2_38_training/source_train.csv `
