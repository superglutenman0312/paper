...
Write-Host "[1/8] Running MALL experiments..."
& "$PSScriptRoot\MALL\run_SWD_MALL.ps1"

Write-Host "[2/8] Running UM_DSI_DB experiments..."
& "$PSScriptRoot\UM_DSI_DB\run_SWD_UM_DSI_DB.ps1"

Write-Host "[3/8] Running UM_DSI_DB_reverse experiments..."
& "$PSScriptRoot\UM_DSI_DB_reverse\run_SWD_UM_DSI_DB_reverse.ps1"

Write-Host "[4/8] Running MCSL experiments..."
& "$PSScriptRoot\MCSL\run_SWD_MCSL.ps1"

Write-Host "[5/8] Running MALL experiments..."
& "$PSScriptRoot\MALL\run_others_MALL.ps1"

Write-Host "[6/8] Running UM_DSI_DB experiments..."
& "$PSScriptRoot\UM_DSI_DB\run_others_UM_DSI_DB.ps1"

Write-Host "[7/8] Running UM_DSI_DB_reverse experiments..."
& "$PSScriptRoot\UM_DSI_DB_reverse\run_others_UM_DSI_DB_reverse.ps1"

Write-Host "[8/8] Running MCSL experiments..."
& "$PSScriptRoot\MCSL\run_others_MCSL.ps1"
