...
# foreach ($Mode in @("unlabeled")) {
    ...
    foreach ($Beta in $BetaValues) {
        ...
        foreach ($Seed in $Seeds) {
            ...
            python .\SWD\SWD.py --training_source_domain_data D:\paper_thesis\My\data\UM_DSI_DB_v1.0.0_lite\data\processed_data\20190611_20191009\source_train.csv `
            ...
            python .\SWD\SWD.py --training_source_domain_data D:\paper_thesis\My\data\UM_DSI_DB_v1.0.0_lite\data\processed_data\20190611_20200219\source_train.csv `
