...
if __name__ == "__main__":
    ...
    map_file_path = r'D:\paper_thesis\My\data\UM_DSI_DB_v1.0.0_lite\data\processed_data\20190611_20200219_masked_outlier_removed\experiment_class_map.csv' # time variant 2
