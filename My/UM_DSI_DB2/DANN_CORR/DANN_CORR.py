...
python DANN_CORR.py --test --work_dir time_variation_1 `
                       --random_seed 42 --unlabeled

# time variation 2
python DANN_CORR.py --training_source_domain_data D:\paper_thesis\My\data\UM_DSI_DB_v1.0.0_lite\data\processed_data\20190611_20200219\source_train.csv `
                      ...
                      --work_dir time_variation_2 `
                        --random_seed 70 --unlabeled --loss_weights 1 1
python DANN_CORR.py --test --work_dir time_variation_2 `
                        --random_seed 70 --unlabeled --loss_weights 1 1
'''
import torch
