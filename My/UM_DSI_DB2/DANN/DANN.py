r'''
# time variation 1
python DANN.py --training_source_domain_data D:\paper_thesis\Histloc_real\Experiment\data\UM_DSI_DB_v1.0.0_lite\data\tony_data\2019-06-11\wireless_training.csv `
...
python DANN.py --test --work_dir time_variation_1/251113_labeled `
                       --random_seed 42 --unlabeled
...
python DANN.py --training_source_domain_data D:\paper_thesis\Histloc_real\Experiment\data\UM_DSI_DB_v1.0.0_lite\data\tony_data\2019-06-11\wireless_training.csv `
                      ...
                      --work_dir time_variation_2/251113_labeled `
                        --random_seed 42 --unlabeled
python DANN.py --test --work_dir time_variation_2/251113_labeled `
                        --random_seed 42 --unlabeled
'''
