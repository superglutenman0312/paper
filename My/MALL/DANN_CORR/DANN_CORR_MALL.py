'''
python DANN_CORR_MALL.py --training_source_domain_data D:/paper_thesis/My/data/MTLocData/Mall/2021-11-20/wireless_training.csv `
...
python DANN_CORR_MALL.py --test --work_dir experiments `
                       --random_seed 42 --unlabeled
'''
import torch
